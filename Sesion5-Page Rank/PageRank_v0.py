...
def main(argv=None):
    ...
    time1 = time.time()
    iterations, newP, rPK  = computePageRanks(P)
    time2 = time.time()
    
    outputPageRanks(newP, "PageRankResults.txt")
    print("#Iterations:", iterations)
    print("Dumping Factor:", damping_factor)
    print("Time of computePageRanks():", time2-time1)
    print("Total Distributed PageRank:", 1-rPK)
    print("Remaining PageRank:", rPK)
